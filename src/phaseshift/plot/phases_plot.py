...
.. code-block:: python
    ...
    >>> from phaseshift.plot.phases_plot import plot_phases
    >>> from phaseshift import compact_fourier_decomposition
...
from phaseshift.lplm_interferometer import LplmDecomp
...
def plot_phases(
    ...
    Args:
        decomposition (FourierDecomp | LplmDecomp): The decomposition object containing the mask sequence. Can be obtained from
            `phaseshift.fourier_interferometer.compact_fourier_decomposition` or
            `phaseshift.lplm_interferometer.lplm_decomposition`.
